...
import com.smolenskyi.sweater.service.MessageService;
...
public class MessageController {
    ...
    public String userMessages(
        ...
        model.addAttribute("subscribersCount", author.getSubscribes().size());
        model.addAttribute("isSubscriber", author.getSubscribes().contains(currentUser));
        model.addAttribute("page", page);
        model.addAttribute("message", message);
