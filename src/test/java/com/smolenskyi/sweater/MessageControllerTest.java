...
import com.smolenskyi.sweater.controller.MessageController;
...
public class MessageControllerTest {
    ...
    public void mainPageTest() throws Exception {
        this.mockMvc.perform(get("/main"))
                ...
                .andExpect(xpath("/html/body/nav/div[2]").string("test_usr1"));
    }
